...
str = re.findall(r"\d+\.\d+","2.34 5.3 .5 2. ")
print(str)
...
Se quisermos fazer uma expressão regular para um número ponto flutuante. Vamos considerar que um número ponto flutuante é um ou mais dígitos, seguido por um .,seguido por um ou mais dígitos. Como o ponto tem um significado especial, precisamos usar um caractere especial de escape \. Podemos usar também \d que representa os dígitos de 0 até 9.
